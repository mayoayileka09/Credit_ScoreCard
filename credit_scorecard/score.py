...
def run(
    csv_rel_path: str = "data/raw/loan_data_2007_2014.csv",
    out_model_rel_path: str = "artifacts/models/credit_risk_PD_model.sav",
    ...
    REPO_ROOT = Path(__file__).resolve().parents[2]  # goes up to repo root
    ...
    if HAS_YELLOWBRICK and make_plots:
    ...
    out = REPO_ROOT / out_model_rel_path
